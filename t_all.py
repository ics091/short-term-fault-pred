...
def pre_data(X, y):
    ...
    X_vail, X_test, y_vail, y_test = train_test_split(X_vail_test, y_vail_test, test_size=0.5)
        ...
        for step, (b_x, b_y) in enumerate(loader):
            ...
            if step % 50 == 0:
                ...
                with torch.no_grad():
                    ...
                    print('epoch', epoch + 1, '|step', step, '|loss: %.5f ' % v_loss.data.numpy(),
                          '|AUC: %.5f ' % roc_auc_score(y_vail, torch.sigmoid(v_output)),
                    ...
                    loss_rec.append(v_loss.data.numpy())
                    AUC_rec.append(roc_auc_score(y_vail, torch.sigmoid(v_output)))
